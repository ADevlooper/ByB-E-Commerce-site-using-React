    ...
    <div className="p-5 font-sans mx-4">
      ...
      <div className="max-w-4xl mx-auto text-center">
        <p className="text-lg mb-6">
          Welcome to BakeBite, where passion for baking meets commitment to health and sustainability.
        ...
        <p className="text-lg mb-6">
          At BakeBite, we believe that great taste and healthy living can go hand in hand. Join us
